...
var name = ['ma', 'ri', 'ana'];
console.log(name.reduce(function(acumulado, value){
    return acumulado + 'P' + value;
}, '') );
...
*/
console.log( '\nInversed Name:' );
var inversedName = name.reduceRight(function(acumulado, value){
...
console.log( numberObjects.lastIndexOf(object, 2) !== -1 ? "Existe um objeto {number: 2} em numberObjects" : "Não existe um objeto {number: 2} em numberObjects :(");
